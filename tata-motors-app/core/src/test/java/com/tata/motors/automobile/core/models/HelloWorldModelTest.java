 ...
 */
package com.tata.motors.automobile.core.models;
...
import com.tata.motors.automobile.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "automobile/components/helloworld");
